...
oper ser_1 : Str -> Verbum = \ser -> 
 ...
 {s = table {
    ...
    VPB (Impf Ind Pl P3) => x_ + "eram" ; --# notpresent
    VPB (Impf Sub Sg P1) => x_ + "fora" ; --# notpresent
    VPB (Impf Sub Sg P2) => x_ + "foras" ; --# notpresent
    VPB (Impf Sub Sg P3) => x_ + "fora" ; --# notpresent
    VPB (Impf Sub Pl P1) => x_ + "foramos" ; --# notpresent
    VPB (Impf Sub Pl P2) => x_ + "forais" ; --# notpresent
    VPB (Impf Sub Pl P3) => x_ + "foram" ; --# notpresent
    VPB (ImpfSub2 Sg P1) => x_ + "fosse" ; --# notpresent
    VPB (ImpfSub2 Sg P2) => x_ + "fosses" ; --# notpresent
    VPB (ImpfSub2 Sg P3) => x_ + "fosse" ; --# notpresent
    VPB (ImpfSub2 Pl P1) => x_ + "fossemos" ; --# notpresent
    VPB (ImpfSub2 Pl P2) => x_ + "fosseis" ; --# notpresent
    VPB (ImpfSub2 Pl P3) => x_ + "fossem" ; --# notpresent
    VPB (Pret Sg P1) => x_ + "fui" ; --# notpresent
    VPB (Pret Sg P2) => x_ + "foste" ; --# notpresent
    VPB (Pret Sg P3) => x_ + "foi" ; --# notpresent
    VPB (Pret Pl P1) => x_ + "fomos" ; --# notpresent
    VPB (Pret Pl P2) => x_ + "fosteis" ; --# notpresent
    VPB (Pret Pl P3) => x_ + "foram" ; --# notpresent
...
oper estar_2 : Str -> Verbum = \estar -> 
 ...
 {s = table {
    ...
    VPB (Impf Ind Sg P1) => est_ + "ava" ; --# notpresent
    VPB (Impf Ind Sg P2) => est_ + "avas" ; --# notpresent
    VPB (Impf Ind Sg P3) => est_ + "ava" ; --# notpresent
    VPB (Impf Ind Pl P1) => est_ + "ávamos" ; --# notpresent
    VPB (Impf Ind Pl P2) => est_ + "áveis" ; --# notpresent
    VPB (Impf Ind Pl P3) => est_ + "avam" ; --# notpresent
    VPB (Impf Sub Sg P1) => est_ + "ivera" ; --# notpresent
    VPB (Impf Sub Sg P2) => est_ + "iveras" ; --# notpresent
    VPB (Impf Sub Sg P3) => est_ + "ivera" ; --# notpresent
    VPB (Impf Sub Pl P1) => est_ + "ivéramos" ; --# notpresent
    VPB (Impf Sub Pl P2) => est_ + "ivéreis" ; --# notpresent
    VPB (Impf Sub Pl P3) => est_ + "iveram" ; --# notpresent
    VPB (ImpfSub2 Sg P1) => est_ + "ivesse" ; --# notpresent
    VPB (ImpfSub2 Sg P2) => est_ + "ivesses" ; --# notpresent
    VPB (ImpfSub2 Sg P3) => est_ + "ivesse" ; --# notpresent
    VPB (ImpfSub2 Pl P1) => est_ + "ivéssemos" ; --# notpresent
    VPB (ImpfSub2 Pl P2) => est_ + "ivésseis" ; --# notpresent
    VPB (ImpfSub2 Pl P3) => est_ + "ivessem" ; --# notpresent
    VPB (Pret Sg P1) => est_ + "ive" ; --# notpresent
    VPB (Pret Sg P2) => est_ + "iviste" ; --# notpresent
    VPB (Pret Sg P3) => est_ + "eve" ; --# notpresent
    VPB (Pret Pl P1) => est_ + "ivemos" ; --# notpresent
    VPB (Pret Pl P2) => est_ + "ivestes" ; --# notpresent
    VPB (Pret Pl P3) => est_ + "ivieram" ; --# notpresent
    ...
    VPB (Fut Sub Sg P2) => est_ + "iveres" ; --# notpresent
...
oper ter_4 : Str -> Verbum = \ter ->
  let t_ = Predef.tk 4 ter in
 {s = table {
    VI Infn => t_ + "er" ;
    VI Ger => t_ + "endo" ;
    VI Part => t_ + "ido" ;
    VPB (Pres Ind Sg P1) => t_ + "enho" ;
    VPB (Pres Ind Sg P2) => t_ + "ens" ;
    VPB (Pres Ind Sg P3) => t_ + "em" ;
    VPB (Pres Ind Pl P1) => t_ + "emos" ;
    VPB (Pres Ind Pl P2) => t_ + "ens" ;
    VPB (Pres Ind Pl P3) => t_ + "êm" ;
    VPB (Pres Sub Sg P1) => t_ + "enha" ;
    VPB (Pres Sub Sg P2) => t_ + "enhas" ;
    VPB (Pres Sub Sg P3) => t_ + "enha" ;
    VPB (Pres Sub Pl P1) => t_ + "enhamos" ;
    VPB (Pres Sub Pl P2) => t_ + "enhais" ;
    VPB (Pres Sub Pl P3) => t_ + "enham" ;
    VPB (Impf Ind Sg P1) => t_ + "tinha" ; --# notpresent
    VPB (Impf Ind Sg P2) => t_ + "tinhas" ; --# notpresent
    VPB (Impf Ind Sg P3) => t_ + "tinha" ; --# notpresent
    VPB (Impf Ind Pl P1) => t_ + "tínhamos" ; --# notpresent
    VPB (Impf Ind Pl P2) => t_ + "tinhais" ; --# notpresent
    VPB (Impf Ind Pl P3) => t_ + "tinham" ; --# notpresent
    VPB (Impf Sub Sg P1) => t_ + "ivera" ; --# notpresent
    VPB (Impf Sub Sg P2) => t_ + "iveras" ; --# notpresent
    VPB (Impf Sub Sg P3) => t_ + "ivera" ; --# notpresent
    VPB (Impf Sub Pl P1) => t_ + "ivéramos" ; --# notpresent
    VPB (Impf Sub Pl P2) => t_ + "iveréis" ; --# notpresent
    VPB (Impf Sub Pl P3) => t_ + "iveram" ; --# notpresent
    VPB (ImpfSub2 Sg P1) => t_ + "ivesse" ; --# notpresent
    VPB (ImpfSub2 Sg P2) => t_ + "ivesses" ; --# notpresent
    VPB (ImpfSub2 Sg P3) => t_ + "ivesse" ; --# notpresent
    VPB (ImpfSub2 Pl P1) => t_ + "ivéssemos" ; --# notpresent
    VPB (ImpfSub2 Pl P2) => t_ + "ivésseis" ; --# notpresent
    VPB (ImpfSub2 Pl P3) => t_ + "ivessem" ; --# notpresent
    VPB (Pret Sg P1) => t_ + "ive" ; --# notpresent
    VPB (Pret Sg P2) => t_ + "tiveste" ; --# notpresent
    VPB (Pret Sg P3) => t_ + "teve" ; --# notpresent
    VPB (Pret Pl P1) => t_ + "tivemos" ; --# notpresent
    VPB (Pret Pl P2) => t_ + "tivésteis" ; --# notpresent
    VPB (Pret Pl P3) => t_ + "tiveram" ; --# notpresent
    VPB (Fut Ind Sg P1) => t_ + "erei" ; --# notpresent
    VPB (Fut Ind Sg P2) => t_ + "erás" ; --# notpresent
    VPB (Fut Ind Sg P3) => t_ + "erá" ; --# notpresent
    VPB (Fut Ind Pl P1) => t_ + "eremos" ; --# notpresent
    VPB (Fut Ind Pl P2) => t_ + "ereis" ; --# notpresent
    VPB (Fut Ind Pl P3) => t_ + "erão" ; --# notpresent
    VPB (Fut Sub Sg P1) => t_ + "iver" ; --# notpresent
    VPB (Fut Sub Sg P2) => t_ + "iveres" ; --# notpresent
    VPB (Fut Sub Sg P3) => t_ + "iver" ; --# notpresent
    VPB (Fut Sub Pl P1) => t_ + "ivéramos" ; --# notpresent
    VPB (Fut Sub Pl P2) => t_ + "ivereis" ; --# notpresent
    VPB (Fut Sub Pl P3) => t_ + "iverem" ; --# notpresent
    VPB (Cond Sg P1) => t_ + "eria" ; --# notpresent
    VPB (Cond Sg P2) => t_ + "erias" ; --# notpresent
    VPB (Cond Sg P3) => t_ + "eria" ; --# notpresent
    VPB (Cond Pl P1) => t_ + "eríamos" ; --# notpresent
    VPB (Cond Pl P2) => t_ + "eríeis" ; --# notpresent
    VPB (Cond Pl P3) => t_ + "eriam" ; --# notpresent
    VPB (Imper Sg P1) => variants {} ;
    VPB (Imper Sg P2) => t_ + "em" ;
    VPB (Imper Sg P3) => t_ + "enha" ;
    VPB (Imper Pl P1) => t_ + "enhamos" ;
    VPB (Imper Pl P2) => t_ + "enhais" ;
    VPB (Imper Pl P3) => t_ + "enham" ;
    VPB (Pass Sg Masc) => t_ + "ido" ;
    VPB (Pass Sg Fem) => t_ + "ida" ;
    VPB (Pass Pl Masc) => t_ + "idos" ;
    VPB (Pass Pl Fem) => t_ + "idas"
    }
  } ;
...
oper cortar_5 : Str -> Verbum = \cortar ->
 ...
 {s = table {
    ...
    VPB (Pres Sub Pl P3) => cort_ + "em" ;
    VPB (Impf Ind Sg P1) => cort_ + "ava" ; --# notpresent
    VPB (Impf Ind Sg P2) => cort_ + "avas" ; --# notpresent
    VPB (Impf Ind Sg P3) => cort_ + "ava" ; --# notpresent
    VPB (Impf Ind Pl P1) => cort_ + "ávamos" ; --# notpresent
    VPB (Impf Ind Pl P2) => cort_ + "avais" ; --# notpresent
    VPB (Impf Ind Pl P3) => cort_ + "avam" ; --# notpresent
    ...
    VPB (Impf Sub Pl P3) => cort_ + "aram" ; --# notpresent
    VPB (ImpfSub2 Sg P1) => cort_ + "asse" ; --# notpresent
    VPB (ImpfSub2 Sg P2) => cort_ + "asses" ; --# notpresent
    VPB (ImpfSub2 Sg P3) => cort_ + "asse" ; --# notpresent
    VPB (ImpfSub2 Pl P1) => cort_ + "ássemos" ; --# notpresent
    VPB (ImpfSub2 Pl P2) => cort_ + "asseis" ; --# notpresent
    VPB (ImpfSub2 Pl P3) => cort_ + "assem" ; --# notpresent
    VPB (Pret Sg P1) => cort_ + "ei" ; --# notpresent
    VPB (Pret Sg P2) => cort_ + "aste" ; --# notpresent
    VPB (Pret Sg P3) => cort_ + "ou" ; --# notpresent
    VPB (Pret Pl P1) => cort_ + "amos" ; --# notpresent
    VPB (Pret Pl P2) => cort_ + "asteis" ; --# notpresent
    VPB (Pret Pl P3) => cort_ + "aram" ; --# notpresent
    VPB (Fut Ind Sg P1) => cort_ + "arei" ; --# notpresent
    ...
    VPB (Fut Ind Pl P3) => cort_ + "arão" ; --# notpresent
...
oper dever_6 : Str -> Verbum = \dever ->
  let dev_ = Predef.tk 2 dever in
 {s = table {
    VI Infn => dev_ + "er" ;
    VI Ger => dev_ + "iendo" ;
    VI Part => dev_ + "ido" ;
    VPB (Pres Ind Sg P1) => dev_ + "o" ;
    VPB (Pres Ind Sg P2) => dev_ + "es" ;
    VPB (Pres Ind Sg P3) => dev_ + "e" ;
    VPB (Pres Ind Pl P1) => dev_ + "emos" ;
    VPB (Pres Ind Pl P2) => dev_ + "eis" ;
    VPB (Pres Ind Pl P3) => dev_ + "em" ;
    VPB (Pres Sub Sg P1) => dev_ + "a" ;
    VPB (Pres Sub Sg P2) => dev_ + "as" ;
    VPB (Pres Sub Sg P3) => dev_ + "a" ;
    VPB (Pres Sub Pl P1) => dev_ + "amos" ;
    VPB (Pres Sub Pl P2) => dev_ + "ais" ;
    VPB (Pres Sub Pl P3) => dev_ + "am" ;
    VPB (Impf Ind Sg P1) => dev_ + "ia" ; --# notpresent
    VPB (Impf Ind Sg P2) => dev_ + "ias" ; --# notpresent
    VPB (Impf Ind Sg P3) => dev_ + "ia" ; --# notpresent
    VPB (Impf Ind Pl P1) => dev_ + "íamos" ; --# notpresent
    VPB (Impf Ind Pl P2) => dev_ + "íeis" ; --# notpresent
    VPB (Impf Ind Pl P3) => dev_ + "iam" ; --# notpresent
    VPB (Impf Sub Sg P1) => dev_ + "era" ; --# notpresent
    VPB (Impf Sub Sg P2) => dev_ + "eras" ; --# notpresent
    VPB (Impf Sub Sg P3) => dev_ + "era" ; --# notpresent
    VPB (Impf Sub Pl P1) => dev_ + "eramos" ; --# notpresent
    VPB (Impf Sub Pl P2) => dev_ + "ereis" ; --# notpresent
    VPB (Impf Sub Pl P3) => dev_ + "eram" ; --# notpresent
    VPB (ImpfSub2 Sg P1) => dev_ + "esse" ; --# notpresent
    VPB (ImpfSub2 Sg P2) => dev_ + "esses" ; --# notpresent
    VPB (ImpfSub2 Sg P3) => dev_ + "esse" ; --# notpresent
    VPB (ImpfSub2 Pl P1) => dev_ + "êssemos" ; --# notpresent
    VPB (ImpfSub2 Pl P2) => dev_ + "esseis" ; --# notpresent
    VPB (ImpfSub2 Pl P3) => dev_ + "essem" ; --# notpresent
    VPB (Pret Sg P1) => dev_ + "i" ; --# notpresent
    VPB (Pret Sg P2) => dev_ + "este" ; --# notpresent
    VPB (Pret Sg P3) => dev_ + "eu" ; --# notpresent
    VPB (Pret Pl P1) => dev_ + "emos" ; --# notpresent
    VPB (Pret Pl P2) => dev_ + "esteis" ; --# notpresent
    VPB (Pret Pl P3) => dev_ + "eram" ; --# notpresent
    VPB (Fut Ind Sg P1) => dev_ + "erei" ; --# notpresent
    VPB (Fut Ind Sg P2) => dev_ + "erás" ; --# notpresent
    VPB (Fut Ind Sg P3) => dev_ + "erá" ; --# notpresent
    VPB (Fut Ind Pl P1) => dev_ + "eremos" ; --# notpresent
    VPB (Fut Ind Pl P2) => dev_ + "eréis" ; --# notpresent
    VPB (Fut Ind Pl P3) => dev_ + "erão" ; --# notpresent
    VPB (Fut Sub Sg P1) => dev_ + "er" ; --# notpresent
    VPB (Fut Sub Sg P2) => dev_ + "eres" ; --# notpresent
    VPB (Fut Sub Sg P3) => dev_ + "er" ; --# notpresent
    VPB (Fut Sub Pl P1) => dev_ + "eremos" ; --# notpresent
    VPB (Fut Sub Pl P2) => dev_ + "eries" ; --# notpresent
    VPB (Fut Sub Pl P3) => dev_ + "erem" ; --# notpresent
    VPB (Cond Sg P1) => dev_ + "eria" ; --# notpresent
    VPB (Cond Sg P2) => dev_ + "erias" ; --# notpresent
    VPB (Cond Sg P3) => dev_ + "eria" ; --# notpresent
    VPB (Cond Pl P1) => dev_ + "eríamos" ; --# notpresent
    VPB (Cond Pl P2) => dev_ + "eríeis" ; --# notpresent
    VPB (Cond Pl P3) => dev_ + "eriam" ; --# notpresent
    VPB (Imper Sg P1) => variants {} ;
    VPB (Imper Sg P2) => dev_ + "e" ;
    VPB (Imper Sg P3) => dev_ + "a" ;
    VPB (Imper Pl P1) => dev_ + "amos" ;
    VPB (Imper Pl P2) => dev_ + "ei" ;
    VPB (Imper Pl P3) => dev_ + "am" ;
    VPB (Pass Sg Masc) => dev_ + "ido" ;
    VPB (Pass Sg Fem) => dev_ + "ida" ;
    VPB (Pass Pl Masc) => dev_ + "idos" ;
    VPB (Pass Pl Fem) => dev_ + "idas"
    }
  } ;
...
oper conhecer_25 : Str -> Verbum = \conhecer ->
  let conhe_ = Predef.tk 3 conhecer in
 {s = table {
    VI Infn => conhe_ + "cer" ;
    VI Ger => conhe_ + "ciendo" ;
    VI Part => conhe_ + "cido" ;
    VPB (Pres Ind Sg P1) => conhe_ + "ço" ;
    VPB (Pres Ind Sg P2) => conhe_ + "ces" ;
    VPB (Pres Ind Sg P3) => conhe_ + "ce" ;
    VPB (Pres Ind Pl P1) => conhe_ + "cemos" ;
    VPB (Pres Ind Pl P2) => conhe_ + "ceis" ;
    VPB (Pres Ind Pl P3) => conhe_ + "cem" ;
    VPB (Pres Sub Sg P1) => conhe_ + "ça" ;
    VPB (Pres Sub Sg P2) => conhe_ + "ças" ;
    VPB (Pres Sub Sg P3) => conhe_ + "ça" ;
    VPB (Pres Sub Pl P1) => conhe_ + "çamos" ;
    VPB (Pres Sub Pl P2) => conhe_ + "çais" ;
    VPB (Pres Sub Pl P3) => conhe_ + "çam" ;
    VPB (Impf Ind Sg P1) => conhe_ + "cia" ; --# notpresent
    VPB (Impf Ind Sg P2) => conhe_ + "cias" ; --# notpresent
    VPB (Impf Ind Sg P3) => conhe_ + "cia" ; --# notpresent
    VPB (Impf Ind Pl P1) => conhe_ + "ciamos" ; --# notpresent
    VPB (Impf Ind Pl P2) => conhe_ + "cíeis" ; --# notpresent
    VPB (Impf Ind Pl P3) => conhe_ + "ciam" ; --# notpresent
    VPB (Impf Sub Sg P1) => conhe_ + "cera" ; --# notpresent
    VPB (Impf Sub Sg P2) => conhe_ + "ceras" ; --# notpresent
    VPB (Impf Sub Sg P3) => conhe_ + "cera" ; --# notpresent
    VPB (Impf Sub Pl P1) => conhe_ + "cêramos" ; --# notpresent
    VPB (Impf Sub Pl P2) => conhe_ + "cêreis" ; --# notpresent
    VPB (Impf Sub Pl P3) => conhe_ + "ceram" ; --# notpresent
    VPB (ImpfSub2 Sg P1) => conhe_ + "cesse" ; --# notpresent
    VPB (ImpfSub2 Sg P2) => conhe_ + "cesses" ; --# notpresent
    VPB (ImpfSub2 Sg P3) => conhe_ + "cesse" ; --# notpresent
    VPB (ImpfSub2 Pl P1) => conhe_ + "cêssemos" ; --# notpresent
    VPB (ImpfSub2 Pl P2) => conhe_ + "cêsseis" ; --# notpresent
    VPB (ImpfSub2 Pl P3) => conhe_ + "cessem" ; --# notpresent
    VPB (Pret Sg P1) => conhe_ + "ci" ; --# notpresent
    VPB (Pret Sg P2) => conhe_ + "ceste" ; --# notpresent
    VPB (Pret Sg P3) => conhe_ + "ceu" ; --# notpresent
    VPB (Pret Pl P1) => conhe_ + "cemos" ; --# notpresent
    VPB (Pret Pl P2) => conhe_ + "cestes" ; --# notpresent
    VPB (Pret Pl P3) => conhe_ + "ceram" ; --# notpresent
    VPB (Fut Ind Sg P1) => conhe_ + "cerei" ; --# notpresent
    VPB (Fut Ind Sg P2) => conhe_ + "cerás" ; --# notpresent
    VPB (Fut Ind Sg P3) => conhe_ + "cerá" ; --# notpresent
    VPB (Fut Ind Pl P1) => conhe_ + "ceremos" ; --# notpresent
    VPB (Fut Ind Pl P2) => conhe_ + "cereis" ; --# notpresent
    VPB (Fut Ind Pl P3) => conhe_ + "cerão" ; --# notpresent
    VPB (Fut Sub Sg P1) => conhe_ + "cer" ; --# notpresent
    VPB (Fut Sub Sg P2) => conhe_ + "ceres" ; --# notpresent
    VPB (Fut Sub Sg P3) => conhe_ + "cer" ; --# notpresent
    VPB (Fut Sub Pl P1) => conhe_ + "cermos" ; --# notpresent
    VPB (Fut Sub Pl P2) => conhe_ + "cerdes" ; --# notpresent
    VPB (Fut Sub Pl P3) => conhe_ + "cerem" ; --# notpresent
    VPB (Cond Sg P1) => conhe_ + "ceria" ; --# notpresent
    VPB (Cond Sg P2) => conhe_ + "cerias" ; --# notpresent
    VPB (Cond Sg P3) => conhe_ + "ceria" ; --# notpresent
    VPB (Cond Pl P1) => conhe_ + "ceríamos" ; --# notpresent
    VPB (Cond Pl P2) => conhe_ + "ceríeis" ; --# notpresent
    VPB (Cond Pl P3) => conhe_ + "ceriam" ; --# notpresent
    VPB (Imper Sg P1) => variants {} ;
    VPB (Imper Sg P2) => conhe_ + "ce" ;
    VPB (Imper Sg P3) => conhe_ + "ça" ;
    VPB (Imper Pl P1) => conhe_ + "çamos" ;
    VPB (Imper Pl P2) => conhe_ + "cei" ;
    VPB (Imper Pl P3) => conhe_ + "çam" ;
    VPB (Pass Sg Masc) => conhe_ + "cido" ;
    VPB (Pass Sg Fem) => conhe_ + "cida" ;
    VPB (Pass Pl Masc) => conhe_ + "cidos" ;
    VPB (Pass Pl Fem) => conhe_ + "cidas"
    }
  } ;
...
oper ir_46 : Str -> Verbum = \ir ->
 ...
 {s = table {
    ...
    VPB (Impf Ind Sg P1) => x_ + "ia" ; --# notpresent
    VPB (Impf Ind Sg P2) => x_ + "ias" ; --# notpresent
    VPB (Impf Ind Sg P3) => x_ + "ia" ; --# notpresent
    VPB (Impf Ind Pl P1) => x_ + "íamos" ; --# notpresent
    VPB (Impf Ind Pl P2) => x_ + "íeis" ; --# notpresent
    VPB (Impf Ind Pl P3) => x_ + "iam" ; --# notpresent
    VPB (Impf Sub Sg P1) => x_ + "fora" ; --# notpresent
    VPB (Impf Sub Sg P2) => x_ + "foras" ; --# notpresent
    VPB (Impf Sub Sg P3) => x_ + "fora" ; --# notpresent
    VPB (Impf Sub Pl P1) => x_ + "fôramos" ; --# notpresent
    VPB (Impf Sub Pl P2) => x_ + "fôreis" ; --# notpresent
    VPB (Impf Sub Pl P3) => x_ + "foram" ; --# notpresent
    VPB (ImpfSub2 Sg P1) => x_ + "fosse" ; --# notpresent
    VPB (ImpfSub2 Sg P2) => x_ + "fosses" ; --# notpresent
    VPB (ImpfSub2 Sg P3) => x_ + "fosse" ; --# notpresent
    VPB (ImpfSub2 Pl P1) => x_ + "fôssemos" ; --# notpresent
    VPB (ImpfSub2 Pl P2) => x_ + "fôsseis" ; --# notpresent
    VPB (ImpfSub2 Pl P3) => x_ + "fossem" ; --# notpresent
    VPB (Pret Sg P1) => x_ + "fui" ; --# notpresent
    VPB (Pret Sg P2) => x_ + "foste" ; --# notpresent
    VPB (Pret Sg P3) => x_ + "foi" ; --# notpresent
    VPB (Pret Pl P1) => x_ + "fomos" ; --# notpresent
    VPB (Pret Pl P2) => x_ + "fostes" ; --# notpresent
    VPB (Pret Pl P3) => x_ + "foram" ; --# notpresent
...
oper jogar_47 : Str -> Verbum = \jugar ->
...
oper ouvir_51 : Str -> Verbum = \ouvir ->
  let ou_ = Predef.tk 2 ouvir in
 {s = table {
    VI Infn => ou_ + "vir" ;
    VI Ger => ou_ + "vindo" ;
    VI Part => ou_ + "vido" ;
    ...
    VPB (Impf Ind Sg P1) => ou_ + "via" ; --# notpresent
    VPB (Impf Ind Sg P2) => ou_ + "vias" ; --# notpresent
    VPB (Impf Ind Sg P3) => ou_ + "via" ; --# notpresent
    VPB (Impf Ind Pl P1) => ou_ + "víamos" ; --# notpresent
    VPB (Impf Ind Pl P2) => ou_ + "víeis" ; --# notpresent
    VPB (Impf Ind Pl P3) => ou_ + "viam" ; --# notpresent
    VPB (Impf Sub Sg P1) => ou_ + "vira" ; --# notpresent
    VPB (Impf Sub Sg P2) => ou_ + "viras" ; --# notpresent
    VPB (Impf Sub Sg P3) => ou_ + "vira" ; --# notpresent
    VPB (Impf Sub Pl P1) => ou_ + "viramos" ; --# notpresent
    VPB (Impf Sub Pl P2) => ou_  + "víreis" ; --# notpresent
    VPB (Impf Sub Pl P3) => ou_  + "viram" ; --# notpresent
    VPB (ImpfSub2 Sg P1) => ou_  + "visse" ; --# notpresent
    VPB (ImpfSub2 Sg P2) => ou_  + "visses" ; --# notpresent
    VPB (ImpfSub2 Sg P3) => ou_  + "visse" ; --# notpresent
    VPB (ImpfSub2 Pl P1) => ou_  + "vissemos" ; --# notpresent
    VPB (ImpfSub2 Pl P2) => ou_  + "vísseis" ; --# notpresent
    VPB (ImpfSub2 Pl P3) => ou_  + "vissem" ; --# notpresent
    VPB (Pret Sg P1) => ou_  + "vi" ; --# notpresent
    VPB (Pret Sg P2) => ou_  + "viste" ; --# notpresent
    VPB (Pret Sg P3) => ou_  + "viu" ; --# notpresent
    VPB (Pret Pl P1) => ou_  + "vimos" ; --# notpresent
    VPB (Pret Pl P2) => ou_  + "vistes" ; --# notpresent
    VPB (Pret Pl P3) => ou_  + "viram" ; --# notpresent
    ...
    VPB (Pass Sg Masc) => ou_  + "vido" ;
    VPB (Pass Sg Fem) => ou_  + "vida" ;
    VPB (Pass Pl Masc) => ou_  + "vidos" ;
    VPB (Pass Pl Fem) => ou_  + "vidas"
    }
  } ;
...
oper saber_71 : Str -> Verbum = \saber ->
 ...
 {s = table {
    ...
    VPB (Impf Ind Sg P1) => s_ + "abia" ; --# notpresent
    VPB (Impf Ind Sg P2) => s_ + "abias" ; --# notpresent
    VPB (Impf Ind Sg P3) => s_ + "abia" ; --# notpresent
    VPB (Impf Ind Pl P1) => s_ + "abíamos" ; --# notpresent
    VPB (Impf Ind Pl P2) => s_ + "abíeis" ; --# notpresent
    VPB (Impf Ind Pl P3) => s_ + "abiam" ; --# notpresent
    VPB (Impf Sub Sg P1) => s_ + "oubera" ; --# notpresent
    VPB (Impf Sub Sg P2) => s_ + "ouberas" ; --# notpresent
    VPB (Impf Sub Sg P3) => s_ + "oubera" ; --# notpresent
    VPB (Impf Sub Pl P1) => s_ + "oubéramos" ; --# notpresent
    VPB (Impf Sub Pl P2) => s_ + "oubéreis" ; --# notpresent
    VPB (Impf Sub Pl P3) => s_ + "ouberam" ; --# notpresent
    VPB (ImpfSub2 Sg P1) => s_ + "oubesse" ; --# notpresent
    VPB (ImpfSub2 Sg P2) => s_ + "oubesses" ; --# notpresent
    VPB (ImpfSub2 Sg P3) => s_ + "oubesse" ; --# notpresent
    VPB (ImpfSub2 Pl P1) => s_ + "oubéssemos" ; --# notpresent
    VPB (ImpfSub2 Pl P2) => s_ + "oubésseis" ; --# notpresent
    VPB (ImpfSub2 Pl P3) => s_ + "oubessem" ; --# notpresent
    VPB (Pret Sg P1) => s_ + "oube" ; --# notpresent
    VPB (Pret Sg P2) => s_ + "oubeste" ; --# notpresent
    VPB (Pret Sg P3) => s_ + "oube" ; --# notpresent
    VPB (Pret Pl P1) => s_ + "oubemos" ; --# notpresent
    VPB (Pret Pl P2) => s_ + "oubestes" ; --# notpresent
    VPB (Pret Pl P3) => s_ + "ouberam" ; --# notpresent
    ...
    VPB (Cond Pl P3) => s_ + "abríam" ; --# notpresent
    VPB (Imper Sg P1) => variants {} ;
